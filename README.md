...
This repository does **not host any files or direct download links**. This repository *only provides information about publicly available lecture notes on economics, i.e. the course names or the lecture notes names, and their authors and affiliations, in order to address the problem of "unknown unknowns"*. Users are encouraged to search for the specified lecture notes on the internet based on the provided information. By not sharing direct links, we aim to respect the intellectual property rights of authors and institutions.
...
- Matthew Shum - Caltech - Industrial Organization (s)
